...
class WaveSystem {
  constructor(scene,combat){this.scene=scene;this.combat=combat;this.wave=0;this.remaining=0;this.spawnTimer=0;this.intermission=0;this.spawnedThisWave=0;this.bossActive=false;this.bossCleared=false;this.defs=[
