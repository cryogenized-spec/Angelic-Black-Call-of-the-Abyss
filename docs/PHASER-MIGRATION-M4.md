...
- First Tomb world presentation is a dedicated `FirstTombWorld` class.
...
- The ground is a real Arcade Physics static body and the Queen collides with it.
...
The world uses actual Phaser display objects/layers for scene composition, while the gameplay world remains coordinate-driven. We do not introduce a tilemap merely for the sake of using one.
